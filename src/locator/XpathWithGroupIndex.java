...
public class XpathWithGroupIndex {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(2000);
		WebElement UN1=driver.findElement(By.xpath("(//input[@type='text'])[1]"));
		UN1.clear();
		UN1.sendKeys("admin");
		System.out.println("UN1: "+UN1.getAttribute("value"));
		WebElement UN2=driver.findElement(By.xpath("(//input[@type='text'])[2]"));
		UN2.clear();		
		UN2.sendKeys("manager");
		System.out.println("UN2: "+UN2.getAttribute("value"));
		WebElement PW1=driver.findElement(By.xpath("(//input[@type='text'])[3]"));
		PW1.clear();
		PW1.sendKeys("manager");
		System.out.println("PW1: "+PW1.getAttribute("value"));
		WebElement PW2=driver.findElement(By.xpath("(//input[@type='text'])[4]"));
		PW2.clear();
